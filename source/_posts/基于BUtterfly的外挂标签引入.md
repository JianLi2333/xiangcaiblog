...
date: 2023-11-11 16:12:39
tags:
---

{% tip home %}
本文档转载自[🧊Akilarの糖果屋🍭](https://jq.qq.com/?_wv=1027&k=EF1Elvqp)
...
3. 移除timeline外挂标签，请使用butterfly新版自带的timeline标签，效果更好。
4. 修复tip标签自定义图标无效的bug
	<!-- endtimeline -->
	<!-- timeline 2022-04-07:发布插件版v1.0.15 -->
5. 调整气泡显隐动画逻辑，避免透明度变换瞬间遮挡到正文。
	<!-- endtimeline -->
	<!-- timeline 2022-04-07:发布插件版v1.0.14 -->
6. 新增气泡注释bubble标签样式。效果比nota标签更好。
7. 支持自定义气泡背景色。
	<!-- endtimeline -->
	<!-- timeline 2022-03-03:发布插件版v1.0.13 -->
8. 新增开关逻辑，iconfont，carousel设为false则不引入。
9. site标签新增灯箱屏蔽，不再支持点击放大图片。
	<!-- endtimeline -->
	<!-- timeline 2022-02-14:发布插件版v1.0.12 -->
10. 剔除了link卡片的无效css
	<!-- endtimeline -->
	<!-- timeline 2022-01-26:发布插件版v1.0.11 -->
11. butterfly_v4.0新增了`timeline`标签，与本插件标签名冲突。可以选择改用标签文档中的源码配置方案并剔除timeline标签或者删除主题原有的timeline标签文件`Blogroot\themes\butterfly\scripts\tag\timeline.js`和`Blogroot\themes\butterfly\source\css\_tags\timeline.styl`。（总之不能共存）
12. 修复了carousel标签刷新后不加载的bug。
	<!-- endtimeline -->
	<!-- timeline 2021-12-23:发布插件版v1.0.10 -->
13. 将所有CDN链接迁移至`unpkg.zhimg.com`
14. 外露所有CDN配置项，支持读者自行更改CDN源
	<!-- endtimeline -->
	<!-- timeline 2021-12-09:发布插件版v1.0.9 -->
15. 调整`link`标签的默认图片缺省值适配，新增`tag_plugins.link.placeholder`配置项。
16. 因为新增了默认图片，新增配置项，所以需要更新版本。如果本身使用link标签就有自己加图片的习惯的，无需升级。
...
3. 使用npm插件安装。
4. 测试版本为butterfly_v3.1.0、3.3.0、3.7.8、3.8.0
5. 插件写法调整为高内聚，理论上不受butterfly主题版本影响。
6. 为了获得完整效果，建议打开主题的beautify配置项和theme_color配置项。
	<!-- endtimeline -->
	<!-- timeline 2021-03-19:正式版v1.61 -->
7. 修复行内图片换行错误。
	<!-- endtimeline -->
	<!-- timeline 2021-02-24:正式版v1.6 -->
8. 新增一个样式标签，进度条progress
	<!-- endtimeline -->
	<!-- timeline 2020-12-31:正式版v1.5 -->
9. 新增两个样式标签，github徽标ghbdage和特效标签wow
10. 移除静态资源中的`fontawesome-animation.min.css`以及`issues.js`，改为CDN引用。
11. 本帖不专门提供特效标签wow的配置方案，若有需要，请查看站内教程[使用wowjs给博客添加动画效果](/posts/abab51cf/)
...
4. 新增Butterfly_v3.4.0的配置文件。
5. 请读者根据自己的主题版本选择替换。
	<!-- endtimeline -->
	<!-- timeline 2020-12-07:正式版v1.21 -->
6. 资源文件无任何改动。
7. 更新了动态标签的使用说明。补全参数配置，更换示例。使得教程更加通俗易懂。
	<!-- endtimeline -->
	<!-- timeline 2020-12-03:正式版v1.2 -->
8. 新增当初弃用的issues.js标签，以配合友链魔改教程中的issues自动更新功能。
9. 更新了静态资源文件，请之前的读者重新覆盖安装。
10. 修改了`fontawesome-animation.min.css`的引入方式，改成使用`@import`注入`index.css`。
	<!-- endtimeline -->
	<!-- timeline 2020-11-16:正式版v1.1 -->
11. 新增tip.js，将小康大佬的渐变色上标标签写法从HTML的方式改成用标签语法编写。
12. 新增动态标签样式anima，使用了fontawesome-animation项目。
13. 新增标签内容夜间模式适配。
	<!-- endtimeline -->
	<!-- timeline 2020-11-15:正式版v1.0 -->
14. 基本完成Volantis外挂标签移植。
15. 移除了btn标签，因为存在冲突。而且不如butterfly自带的button样式好看。
16. 适配了folding标签的夜间模式。
17. 打包了静态资源文件，上传蓝奏云。
	<!-- endtimeline -->
	<!-- timeline 2020-11-14:内测版v0.05 -->
18. 主要使用了[Volantis](https://github.com/volantis-x/hexo-theme-volantis)的标签样式。引入`[tag].js`，并针对`butterfly`主题修改了相应的`[tag].styl`。在此鸣谢`Volantis`主题众开发者。
19. 主要参考内容
...
{% gallery %}
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613613.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613676.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613606.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613615.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613145.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613140.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613128.jpg)
![](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613388.jpg)
{% endgallery %}
...
2. 新建active label
  ...
  ![新建label用于控制审核结果](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613076.png)

  ![配置名称描述颜色](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613292.png)

3. 提交示例

  ![填写规范](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613704.png)
  ![审核通过](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613010.png)
...
2. 新建active标签
  ...
  ![新建标签用于控制审核结果](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613662.png)


3. 提交示例

  ![填写规范](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613634.png)
  ![审核通过](https://pic.xiangcaiblog.top/images/2023/11/11/202311111613207.png)
